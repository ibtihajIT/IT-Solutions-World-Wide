    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-left mt-8 max-w-3xl mx-auto">
        ...
        <ul className="text-gray-700 list-disc mb-4">
          ...
          <li>
            Minimum 2+ years consulting experience in implementing Oracle Fusion
            Supply Chain Modules or 3+ years consulting experience in
            implementing Oracle EBS Supply Chain Modules
          </li>
