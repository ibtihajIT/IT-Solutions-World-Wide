...
import backgroundImage from "../../assets/warehouse_assets/Background Image.png"; // Update with your image file path
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
        <div className="welcome-content mx-8 max-w-[1080px] p-8 sm:p-4 bg-[#F8F8F8] bg-opacity-90 rounded-3xl">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-[#278083] font-normal mb-4">
            Crafting the ideal warehouse layout design is akin to navigating
            through a labyrinth, a task where even angels might hesitate.
          </p>
        </div>
      </div>
    </div>
